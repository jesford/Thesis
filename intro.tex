...
We do not observe the true shear, however, but rather the reduced shear  $g(\bm{\theta}) = \gamma (\bm{\theta}) \left[1-\kappa (\bm{\theta}) \right]^{-1}$. We can thus rewrite the Jacobian matrix as:
\begin{equation}
...
\textcolor{red}{The observed shape of galaxy can be written as ... and the intrinsic source shape is ...}
