...
It is useful to introduce the Hubble rate $H(t) \equiv {\dot a}/a$, which, at present the present time $t_0$, is equal to the Hubble constant $H_0$. Thus we can re-write the Friedmann Equation, describing the evolution of the universe, in this form:
\begin{equation}
...
Gravitational lensing is broadly divided into several branches depending upon the strength of the lensing effect. Strong lensing refers to the rarest and most obvious distortions, leading to images of giant arcs, Einstein rings, and multiple images of the same source. Strong lensing features are generally apparent to the eye, whereas weak and micro lensing are not. \textcolor{red}{Strong lensing background...}

Weak lensing, just as the name implies, leads to much less significant distortions. However, unlike the rarity of a strong lensing event, weak lensing is everywhere. Essentially all light rays are distorted at least a bit while traveling to us through the small-scale inhomogeneities of the universe. Weak lensing itself, and different methods of measuring it, will be discussed in much more detail below. 

Finally, microlensing is the even weaker signature of gravitational lensing, usually employed to study low mass compact objects like black holes, brown dwarfs, and \textcolor{red}{??? Probably the most famous? use of microlensing has been the search for a significant \acf{MACHO} population. \ac{MACHO}s were considered a serious dark matter candidate until ruled out by ???}
