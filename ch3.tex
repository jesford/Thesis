...
\begin{table}
  \begin{center}
    \caption[Centroid Offset Fit Parameters]{Best Fit Rayleigh Distributions for the Cluster Miscentering in \autoref{plot:gauss3}.}
\label{table13}
