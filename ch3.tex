...
\resizebox{0.5\columnwidth}{!}{
    \begin{tabular}{llll}
      \hline \\[-10pt]
      Mass Range [${\rm M}_{\odot}$] & Color & Best fit $\sigma_{\rm{off}}$ [arcmin] & $\chi^2_{\rm red}$ \\[2pt] \hline \\[-10pt]
      (1.5-5)$\times10^{13}$ & red    & 0.37$\pm$0.06 & 1.8  \\
      (5-10)$\times10^{13}$  & green  & 0.42$\pm$0.06 & 1.4  \\
      (1-2.5)$\times10^{14}$ & blue   & 0.42$\pm$0.06 & 1.2  \\ 
      $\geq$2.5$\times10^{14}$   & purple & 0.45$\pm$0.06 & 1.4  \\[2pt] \hline \\[-10pt]
      $\geq$1.5$\times10^{13}$  & black  & 0.40$\pm$0.06 & 1.1  \\[2pt]
      \hline
    \end{tabular}
}
  \end{center}
